...
{
    public class DamagedCastleWall : Building
    {
        ...
        public override void TickRare()
        {
            ...
            {
                Thing thingToMake = GenSpawn.Spawn(ThingMaker.MakeThing(VFEM_DefOf.VFEM2_CastleWall, this.Stuff), this.PositionHeld, this.Map);
