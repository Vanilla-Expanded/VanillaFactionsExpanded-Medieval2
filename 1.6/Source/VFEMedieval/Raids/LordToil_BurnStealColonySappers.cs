...
{
	public class LordToil_BurnStealColonySappers : LordToil
	{
		...
		public LordToil_BurnStealColonySappers()
		{
		...
		public override void UpdateAllDuties()
		{
			...
			for (int k = 0; k < lord.ownedPawns.Count; k++)
			{
				...
				//{
				// //Log.Message(pawn3 + " - " + pawn3.mindState.duty?.def + " changing duty to " + VFEM_DefOf.VFEM_BurnAndStealColony);
				//	pawn3.mindState.duty = new PawnDuty(VFEM_DefOf.VFEM_BurnAndStealColony);
				//}
			}
		}
