    ...
    public class StockGenerator_MedievalMercs : StockGenerator
    {
        ...
        public override IEnumerable<Thing> GenerateThings(int forTile, Faction faction = null)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                PawnGenerationRequest request = new PawnGenerationRequest(VFEM_DefOf.VFEM_SellSword, mercFaction, PawnGenerationContext.NonPlayer, forTile, mustBeCapableOfViolence: true);
