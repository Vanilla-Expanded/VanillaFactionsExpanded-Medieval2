...
{
	public class LordJob_BurnAndStealColony : LordJob
	{
		...
		public LordJob_BurnAndStealColony()
		{
		}

		public LordJob_BurnAndStealColony(SpawnedPawnParams parms)
		{
		...
		public LordJob_BurnAndStealColony(Faction assaulterFaction, bool canKidnap = true, bool canTimeoutOrFlee = true, bool sappers = false, bool useAvoidGridSmart = false, bool canSteal = true)
		{
